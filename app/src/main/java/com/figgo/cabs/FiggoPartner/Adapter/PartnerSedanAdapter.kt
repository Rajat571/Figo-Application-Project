...
import com.figgo.cabs.FiggoPartner.Model.PartnerSedan
import com.figgo.cabs.R


class PartnerSedanAdapter(var booking:List<PartnerSedan>):RecyclerView.Adapter<PartnerSedanAdapter.ViewHolder>() {
