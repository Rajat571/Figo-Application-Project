...
import com.figgo.cabs.figgodriver.Adapter.ViewHolder
import com.figgo.cabs.figgodriver.model.PaymentHistoryModel

class PartnerPaymentHistoryAdapter(var data:List<PaymentHistoryModel>): RecyclerView.Adapter<PaymentHolder>() {
