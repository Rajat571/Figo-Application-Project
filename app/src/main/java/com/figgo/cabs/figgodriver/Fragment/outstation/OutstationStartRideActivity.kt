...
import com.figgo.cabs.databinding.ActivityOutstationStartRideBinding
...
class OutstationStartRideActivity: AppCompatActivity(), OnMapReadyCallback {
    ...
    lateinit var binding: ActivityOutstationStartRideBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bookingID  = findViewById(R.id.outstation_end_booking_customer)
        bookingType = findViewById(R.id.outstation_end_booking_type)
        pickuplocation = findViewById(R.id.outstation_end_pickup_location)
        fareprice = findViewById(R.id.outstation_end_price)
        dropLocationTV = findViewById(R.id.outstation_end_drop_location)
...
/*        val database = FirebaseDatabase.getInstance()
        ...
        mapFragment.getMapAsync {
            ...
            binding.outstationGoLocation.setOnClickListener {
