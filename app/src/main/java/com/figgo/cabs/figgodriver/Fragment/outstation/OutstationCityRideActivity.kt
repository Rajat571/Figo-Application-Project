...
import com.figgo.cabs.databinding.ActivityOutstationCityRideBinding
import com.figgo.cabs.figgodriver.Fragment.outstation.OutstationCustomerCityRideDetailActivity
...
class OutstationCityRideActivity : AppCompatActivity()
{
    lateinit var binding: ActivityOutstationCityRideBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
         acceptwaitLayout=findViewById(R.id.outsation_cityride_wait_layout)
         Log.d("CityRideActivity","ride_id====="+ride_id)
         binding.outsationLocationTo.text=address_to
         binding.outsationLocationFrom.text=intent.getStringExtra("location_from")
         binding.outsationCityRideDate.text=date
         binding.outsationCityRideTime.text=time
         binding.outsationBookingId.text=customer_booking_id
         binding.outsationPrice.text=intent.getStringExtra("price").toString()
 ...
 /*               if (location == null)
        ...
        /* val mapFragment = supportFragmentManager.findFragmentById(R.id.outsation_mapap) as SupportMapFragment
...
*/
    ...
    private fun acceptwait() {
        ...
        //   Toast.makeText(this,"Accept API RUNNING",Toast.LENGTH_SHORT).show()
        var min = 5
        var sec: Int = 60
                            ...
                            if (!status.equals("pending")) {
                                ...
                                alertDialog2.setPositiveButton("Yes") { dialog: DialogInterface?, which: Int ->
                                    ...
                                    if (outstation_id==2){}
                                        ...
                                        startActivity(
                                            Intent(this, OutstationCustomerCityRideDetailActivity::class.java)
                ...
                object : JsonObjectRequest(Method.POST, url, json,
                    com.android.volley.Response.Listener<JSONObject?> { response ->
                        ...
                        if (response != null) {
                            ...
                            customer_id = customer.getString("id")
                            customer_name = customer.getString("name")
                            price=response.getJSONObject("data").getJSONObject("ride").getJSONObject("price")
                                .getString("avg")
                            customer_contact = customer.getString("contact_no")
                            Toast.makeText(this, status, Toast.LENGTH_SHORT).show()
                            prefManager.setActiveRide(1)
            ...
            object : JsonObjectRequest(Method.POST, url,json,
                com.android.volley.Response.Listener<JSONObject?> { response ->
                    ...
                    if (statuss.equals(true)) {
                        var message=response.getString("message")
                        Toast.makeText(this@OutstationCityRideActivity, "rejected"+message, Toast.LENGTH_LONG).show()
                        //finish()
                    ...
                    override fun onErrorResponse(error: VolleyError?) {
                        ...
                        Toast.makeText(this@OutstationCityRideActivity, "Something went wrong!", Toast.LENGTH_LONG).show()
                    }
                })
