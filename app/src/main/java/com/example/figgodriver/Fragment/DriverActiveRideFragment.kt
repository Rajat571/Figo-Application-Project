 ...
 * Use the [DriverActiveRideFragment.newInstance] factory method to
...
class DriverActiveRideFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DriverActiveRideFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DriverActiveRideFragment().apply {
